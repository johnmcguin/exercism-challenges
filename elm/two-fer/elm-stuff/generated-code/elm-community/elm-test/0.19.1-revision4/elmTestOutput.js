...
var $author$project$TwoFer$twoFer = function (name) {
	if (name.$ === 'Just') {
		var theName = name.a;
		return 'One for ' + (theName + ', one for me.');
	} else {
...
var $author$project$Test$Generated$Main1984151066$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		globs: _List_Nil,
		paths: _List_fromArray(
			['/Users/john/Exercism/elm/two-fer/tests/Tests.elm']),
		processes: 4,
		report: $author$project$Test$Reporter$Reporter$ConsoleReport($author$project$Console$Text$UseColor),
		runs: $elm$core$Maybe$Nothing,
		seed: 291670053724415
	},
...
_Platform_export({'Test':{'Generated':{'Main1984151066':{'init':$author$project$Test$Generated$Main1984151066$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-3801.sock";
