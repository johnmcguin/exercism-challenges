...
var $author$project$Isogram$normalizedSentenceAsSet = function (sentence) {
	return $elm$core$Set$fromList(sentence);
};
var $elm$core$String$toLower = _String_toLower;
var $author$project$Isogram$sentenceToNormalizedList = function (sentence) {
	return A2(
		$elm$core$List$filter,
...
var $author$project$Isogram$isIsogram = function (sentence) {
	var list = $author$project$Isogram$sentenceToNormalizedList(sentence);
	var set = $author$project$Isogram$normalizedSentenceAsSet(list);
	return _Utils_eq(
		$elm$core$List$length(list),
		$elm$core$Set$size(set)) ? true : false;
};
...
var $author$project$Test$Generated$Main4019622748$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		globs: _List_Nil,
		paths: _List_fromArray(
			['/Users/john/Exercism/elm/isogram/tests/Tests.elm']),
		processes: 4,
		report: $author$project$Test$Reporter$Reporter$ConsoleReport($author$project$Console$Text$UseColor),
		runs: $elm$core$Maybe$Nothing,
		seed: 267622285609762
	},
...
_Platform_export({'Test':{'Generated':{'Main4019622748':{'init':$author$project$Test$Generated$Main4019622748$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-12330.sock";
